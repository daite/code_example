...
def game_main():
    ...
    bg_pos = (bg_pos + 1) % height
    canvas.create_image(width / 2, bg_pos - height / 2, image=img_bg, tag="SCREEN")
    canvas.create_image(width / 2, bg_pos + height / 2, image=img_bg, tag="SCREEN")
    if index == 0:
        canvas.create_text(width / 2, 100, text="meteor".upper(), font=("Times New Roman", 30), fill="white", tag="SCREEN")
    ...
    if koff == True:
        key = ""
        koff = False
    canvas.create_text(100, 50, text="Index: {}".format(index), font=("Times New Roman", 30), fill="white", tag="SCREEN")
    canvas.create_text(370, 50, text="Score: {}".format(score), font=("Times New Roman", 30), fill="white", tag="SCREEN")
